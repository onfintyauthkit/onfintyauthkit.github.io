...
- [Backend Options](#backend-options)
  - [Option 1: Mock Backend (Testing/Demo)](#option-1-mock-backend-testingdemo)
  - [Option 2: Firebase Authentication](#option-2-firebase-authentication)
  - [Option 3: Supabase Authentication](#option-3-supabase-authentication)
  - [Option 4: Custom REST API](#option-4-custom-rest-api)
  - [Option 5: Build Your Own](#option-5-build-your-own)
...
class RestApiAuthImplementation implements AuthInterface {
  ...
  // You'll need to manage token storage (use SharedPreferences or secure_storage)
  String? _token;
